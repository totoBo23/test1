...
- Simplified calculator (5 steps, including result)
- Innsbruck-first messaging and defaults
- Trust and security section (document handling + process transparency)
- Richtwert logic by Austrian state
- Overpayment estimate based on contract duration
...
The calculator no longer asks for full address details.
It uses only the selected Austrian federal state (`Bundesland`) for Richtwert calculation.
